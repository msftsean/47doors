...
export function ChatContainer({
  ...
  const { startVoiceSession, stopVoiceSession, voiceState, transcript, isVoiceSupported, error } =
    useVoiceChat({
      sessionId,
      onTranscriptMessage: onVoiceMessage,
    });
  ...
  return (
    <div className="flex-1 flex flex-col h-[calc(100vh-80px)]">
      ...
      {/* Voice chat panel — shown when voice session is active */}
      {isVoiceSupported && (
        <VoiceChat
