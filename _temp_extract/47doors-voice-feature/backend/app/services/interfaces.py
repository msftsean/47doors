...
class RealtimeServiceInterface(ABC):
    """Interface for Azure OpenAI Realtime API integration (voice)."""

    @abstractmethod
    async def create_session(self) -> dict:
        """
        Create a Realtime API session and return ephemeral token + endpoint.

        Returns:
            dict with keys: token, endpoint, tool_definitions, voice_config
        """
        pass
    ...
    def get_tool_definitions(self) -> list[dict]:
        ...
        Returns:
            List of tool definition dicts compatible with Realtime API.
        """
        pass
    ...
    async def execute_tool(
        ...
        Args:
            ...
            arguments: Tool arguments from the Realtime API.
            session_id: Optional session ID for stateful context.

        Returns:
            Tool result dict to send back to the Realtime API.
        """
        pass
