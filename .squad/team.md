...
> 47 Doors — Universal Front Door Support Agent for university student support
...
| Neo | Security | `.squad/agents/neo/charter.md` | ✅ Active |
...
- **Description:** Three-agent AI system (QueryAgent → RouterAgent → ActionAgent) providing a single intelligent entry point for university student support, with voice interaction via WebRTC
- **Created:** 2026-03-13
